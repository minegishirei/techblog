...
| キーワード    | 目的     | 補足説明   | 
| ------------ | ------------ | ---- | 
| [`アジャイル`](https://minegishirei.hatenablog.com/entry/2023/01/27/164337) | 無駄な機能を付けない |     - あのExcelですら全体の80%の機能が使われていないそうです。これさえ意識すれば必要な作業量は1/5になります。<br>    - MVP(価値の判定が可能な最小限の成果物)を高速で作ることで、無駄なものを作りません。 | 
